...
void main() {
    mat4 modelMatrix = M * instanceModelMatrix;

    worldSpace.position = (modelMatrix * vec4(vertexPosition, 1)).xyz;
    worldSpace.normal = normalize(modelMatrix * vec4(vertexNormal, 0)).xyz;
